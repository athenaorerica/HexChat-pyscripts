# randomkicks.py by ApolloJustice
...
def kickquote(word, word_eol, userdata):
	...
	hexchat.command("raw kick  " + chan + " " + word[1] + " " + ":" + reason + "%s" % (isBan))

	return hexchat.EAT_ALL

hexchat.hook_command("kick", kickquote, userdata="", help="/kick Kicks a user.")
hexchat.hook_command("kickban", kickquote, userdata=" [Banned]", help="/kickban Kicks and bans a user.")
